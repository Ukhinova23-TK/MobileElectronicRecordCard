...
class MarkControlTypeMapper implements Mapper<MarkControlTypeEntity, Mark_control_type> {
  @override
  MarkControlTypeEntity toEntity (Mark_control_type model) {
    return MarkControlTypeEntity(
        markId: model.markId,
        controlTypeId: model.control_typeId
    );
  }
  ...
  Mark_control_type toModel(MarkControlTypeEntity entity) {
    return Mark_control_type(
        ...
        control_typeId: entity.controlTypeId
    );
  }
